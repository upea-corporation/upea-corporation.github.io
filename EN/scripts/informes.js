document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCalendar(month, year) {
        ...
        let calendarHTML = `
            <h2>Operations Report Register</h2>
            <p>Below is a calendar showing the dates on which relevant reports were issued by UPEA Corporation.</p>
            <p>Days marked in red indicate serious or internal reports. Days marked in blue indicate mission and activity reports. Days marked in yellow indicate technical and safety reports. Days marked in purple indicate mixed reports.</p>
