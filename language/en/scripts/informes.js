document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCalendar(month, year) {
        ...
        let calendarHTML = `
            ...
            <p>Below is a calendar showing the days on which relevant reports were issued by UPEA Corporation.</p>
            <p>Days marked in red signify serious or internal reports. Days marked in blue signify mission and activity reports. Days marked in yellow signify technical and security reports. Days marked in purple signify mixed reports.</p>
